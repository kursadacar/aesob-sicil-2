...
!function($) {
    function Inputmask(alias, options) {
        return this instanceof Inputmask
            ? ($.isPlainObject(alias)
                ...
                this.events = {}, void resolveAlias(this.opts.alias, options, this.opts))
    ...
    function isElementTypeSupported(input, opts) {
        var elementType = input.getAttribute("type"),
            isSupported = "INPUT" === input.tagName && -1 !== $.inArray(elementType, opts.supportsInputType) ||
    ...
    function generateMaskSet(opts, nocache) {
        function analyseMask(mask) {
            ...
            function insertTestDefinition(mtoken, element, position) {
                ...
                if (maskdef && !escaped) {
                    maskdef.placeholder =
                        $.isFunction(maskdef.placeholder) ? maskdef.placeholder(opts) : maskdef.placeholder;
            ...
            function defaultCase() {
                if (openenings.length > 0) {
                    if (currentOpeningToken = openenings[openenings.length - 1], maskCurrentToken(m,
                            currentOpeningToken,
                            lastMatch,
                        ...
                        if (("*" === mq1 || "+" === mq1) && (mq0 = "*" === mq1 ? 0 : 1), quantifier.quantifier = {
                            ...
                            match = currentToken.matches.pop(), match.isGroup ||
                                (groupToken = new MaskToken(!0),
                                    groupToken.matches.push(match), match = groupToken), currentToken.matches.push(
                                    match),
            ...
            return currentToken.matches.length > 0 &&
                (lastMatch = currentToken.matches[currentToken.matches.length - 1],
                    verifyGroupMarker(lastMatch), maskTokens.push(currentToken)), opts.numericInput &&
        ...
        function generateMask(mask, metadata) {
            ...
            return void 0 === Inputmask.prototype.masksCache[mask] || nocache === !0
                    ...
                    (Inputmask.prototype.masksCache[opts.numericInput ? mask.split("").reverse().join("") : mask] =
                            masksetDefinition,
        ...
        if ($.isFunction(opts.mask) && (opts.mask = opts.mask(opts)), $.isArray(opts.mask)) {
            if (opts.mask.length > 1) {
                ...
                return $.each(opts.numericInput ? opts.mask.reverse() : opts.mask,
                    function(ndx, msk) {
                        altMask.length > 1 && (altMask += ")|("), altMask += preProcessMask(
    ...
    function maskScope(actionObj, maskset, opts) {
        function getMaskTemplate(baseOnInput, minimalPos, includeInput) {
            ...
            do {
                if (baseOnInput === !0 && getMaskSet().validPositions[pos]) {
                    ...
                    test = validPos.match, ndxIntlzr =
                        validPos.locator.slice(), maskTemplate.push(includeInput === !0
                        ? validPos.input
                ...
                pos++;
            } while ((void 0 === maxLength || maxLength > pos - 1) && null !== test.fn ||
        ...
        function setValidPosition(pos, validTest, fromSetValid, isSelection) {
            if (isSelection ||
                ...
                for (i = j = pos; lvp >= i; i++) {
                    ...
                    if (void 0 !== t)
                        for (var posMatch = j, prevPosMatch = -1;
                            ...
                            if (null === t.match.fn ||
                                    !opts.keepStatic &&
                                    vps[i] &&
                                    (void 0 !== vps[i + 1] && getTests(i + 1, vps[i].locator.slice(), i).length > 1 ||
        ...
        function stripValidPositions(start, end, nocheck, strict) {
            ...
            for (resetMaskSet(!0), i = startPos + 1; i <= getLastValidPosition();) {
                ...
                if (startPos > i && (i = startPos + 1), void 0 === getMaskSet().validPositions[i] && isMask(i) ||
                    void 0 !== s) i++;
                else {
        ...
        function getTestTemplate(pos, ndxIntlzr, tstPs) {
            ...
            if (void 0 === testPos)
                for (var testPositions = getTests(pos, ndxIntlzr, tstPs),
                ...
                $.each(getMaskSet().tests[pos] || [getMaskSet().validPositions[pos]],
                    function(ndx, lmnt) {
                        var ndxPos = lmnt.alternation
                            ? lmnt.locator[lmnt.alternation].toString().indexOf(alternateNdx)
                            : -1;
        ...
        function getTests(pos, ndxIntlzr, tstPs) {
                    ...
                    if (void 0 !== match.matches) {
                        if (match.isGroup && quantifierRecurse !== match) {
                            ...
                            if (-1 === altIndex || "string" == typeof altIndex) {
                                ...
                                for (var ndx = 0; ndx < altIndexArr.length; ndx++) {
                                    if (amndx = parseInt(altIndexArr[ndx]), matches = [], ndxInitializer =
                                            resolveNdxInitializer(testPos, amndx),
                                ...
                                (malternateMatches = $.map(malternateMatches,
                                    ...
                                    })), matches = currentMatches.concat(malternateMatches), testPos = pos, insertStop =
                                    matches.length > 0;
                            } else
                            ...
                            for (var qt = match, qndx = ndxInitializer.length > 0 ? ndxInitializer.shift() : 0;
                                qndx < (isNaN(qt.quantifier.max) ? qndx + 1 : qt.quantifier.max) && pos >= testPos;
                                qndx++) {
            ...
            function mergeLocators(tests) {
                var locator = [];
                return $.isArray(tests) || (tests = [tests]), void 0 === tests[0].alternation
        ...
        function isValid(pos, c, strict, fromSetValid) {
                    ...
                    function(ndx, tst) {
                        ...
                        if (c && (chrs += c), getBuffer(!0), rslt = null != test.fn
                            ...
                            ($.isArray(rslt.insert) || (rslt.insert = [rslt.insert]),
                                ...
                                if (strict = !0, refreshFromBuffer(refresh === !0 ? refresh : refresh.start,
                                        refresh.end,
                ...
                if (void 0 !== alternation) {
                    ...
                    for (var decisionPos in getMaskSet().validPositions)
                        if (decisionPos = parseInt(decisionPos),
                            altPos = getMaskSet().validPositions[decisionPos], decisionPos >= lastAlt &&
                                void 0 !== altPos.alternation) {
                            var altNdxs;
                            0 === lastAlt
                                ...
                                if (decisionTaker < altNdxs[mndx]) {
                                    for (var possibilityPos, possibilities, dp = decisionPos; dp >= 0; dp--)
                                        if (possibilityPos = getMaskSet().validPositions[dp],
                                            ...
                                            getMaskSet().validPositions[dp].match.def !== bestMatch.match.def &&
                                                (validInputs.push(getMaskSet().validPositions[dp].input),
                                                    getMaskSet().validPositions[dp] =
                                                        bestMatch, getMaskSet().validPositions[dp].input =
                                                        getPlaceholder(dp),
                                                    null === getMaskSet().validPositions[dp].match.fn &&
                                                        staticInputsBeforePosAlternate++,
                                                    possibilityPos = bestMatch), possibilities =
                                    ...
                                    if (decisionTaker !== possibilityPos.locator[alternation]) {
                                        ...
                                        for (resetMaskSet(!0), opts.keepStatic = !opts.keepStatic, isValidRslt = !0;
                                            validInputs.length > 0;
                                        ) {
                                            var input = validInputs.shift();
                                            if (input !== opts.skipOptionalPartCharacter &&
                                                !(isValidRslt = isValid(getLastValidPosition(void 0, !0) + 1,
                                                    input,
                                                    !1,
                                                    fromSetValid))) break;
                                        }
                                        if (possibilityPos.alternation =
                                                alternation, possibilityPos.locator[alternation] = possibilities,
                                            isValidRslt) {
                                        ...
                                        resetMaskSet(), getMaskSet().validPositions =
                                            $.extend(!0, {}, validPsClone), getMaskSet().tests =
                                            $.extend(!0, {}, testsClone);
                                    }
                                }
                            }
            ...
            function trackbackAlternations(originalPos, newPos) {
                for (var vp = getMaskSet().validPositions[newPos],
            ...
            for (var result = !1, positionsClone = $.extend(!0, {}, getMaskSet().validPositions), pndx = maskPos - 1;
            ...
            for (pndx++; maskPos > pndx; pndx++)
                void 0 === getMaskSet().validPositions[pndx] &&
                    ...
                    ((testTemplate = getTestTemplate(pndx)).match.def === opts.radixPointDefinitionSymbol ||
                        !isMask(pndx, !0) ||
                    ...
                    _isValid(getLastValidPosition(pndx, !0) + 1,
            ...
            if (isSelection(pos) && (handleRemove(void 0, Inputmask.keyCode.DELETE, pos), maskPos = getMaskSet().p),
                ...
                if (!currentPosValid ||
                    ...
                    if ((opts.insertMode || void 0 === getMaskSet().validPositions[seekNext(maskPos)]) &&
                        ...
                        staticChar =
                            staticChar.placeholder || staticChar.def, _isValid(maskPos,
                            staticChar,
                            strict,
                            fromSetValid);
        ...
        function isMask(pos, strict) {
            var test;
            if (strict
                    ? (test = getTestTemplate(pos).match, "" === test.def && (test = getTest(pos)))
                    : test = getTest(pos),
        ...
        function getMaskLength() {
            ...
            return maskLength =
                "" !== lastTest.def ? pos : pos - 1, void 0 === maxLength || maxLength > maskLength
                ? maskLength
                : maxLength;
        }
        ...
        function seekNext(pos, newBlock) {
            ...
            for (var position = pos;
                ++position < maskL &&
                (newBlock === !0 && (getTest(position).newBlockMarker !== !0 || !isMask(position)) ||
                    newBlock !== !0 && !isMask(position) && (opts.nojumps !== !0 || opts.nojumpsThreshold > position));
            );
            return position;
        }
        ...
        function checkVal(input, writeOut, strict, nptvl) {
            function isTemplateMatch() {
                var isMatch = !1,
                    charCodeNdx = getBufferTemplate().slice(initialNdx, seekNext(initialNdx)).join("")
                        .indexOf(charCodes);
            ...
            $.each(inputValue,
                ...
                writeBuffer(input,
                    getBuffer(),
                    document.activeElement === input ? seekNext(getLastValidPosition(0)) : void 0,
                    new $.Event("checkval"));
        }
                    ...
                    $.valHooks[type] = {
                        get: function(elem) {
                            if (elem.inputmask) {
                                ...
                                return -1 !==
                                    getLastValidPosition(void 0, void 0, elem.inputmask.maskset.validPositions) ||
                                    opts.nullable !== !0
                                    ? result
                                    : "";
                            }
                ...
                if (opts.keepStatic) {
                    ...
                    for (lastAlt = getLastValidPosition(); lastAlt >= 0; lastAlt--) {
                        ...
                        (null != validPos.match.fn && validInputs.push(validPos.input),
                            delete getMaskSet().validPositions[lastAlt], void 0 !== validPos.alternation &&
                    ...
                    if (lastAlt > -1)
                        for (; validInputs.length > 0;) {
                            ...
                            var keypress = new $.Event("keypress");
                            keypress.which =
                                validInputs.pop().charCodeAt(0), keypressEvent.call(input,
                                keypress,
                                !0,
                                !1,
                                !1,
        ...
        function keydownEvent(e) {
            ...
            if (k === Inputmask.keyCode.BACKSPACE ||
                ...
                e.preventDefault(),
                    handleRemove(input, k, pos), writeBuffer(input,
                        getBuffer(),
                        getMaskSet().p,
                        e,
                ...
                opts.insertMode || caretPos !== getMaskLength() || e.shiftKey || caretPos--, caret(input,
                ...
                k === Inputmask.keyCode.HOME && !e.shiftKey || k === Inputmask.keyCode.PAGE_UP
                    ...
                    : (opts.undoOnEscape && k === Inputmask.keyCode.ESCAPE || 90 === k && e.ctrlKey) && e.altKey !== !0
                    ...
                    ? (e.shiftKey === !0
                        ? (null === getTest(pos.begin).fn && (pos.begin = seekNext(pos.begin)),
                            pos.end = seekPrevious(pos.begin, !0), pos.begin = seekPrevious(pos.end, !0))
                        : (pos.begin = seekNext(pos.begin, !0),
                            pos.end = seekNext(pos.begin, !0), pos.end < getMaskLength() && pos.end--), pos.begin <
                        getMaskLength() &&
                        (e.preventDefault(),
                    ...
                    : (opts.insertMode = !opts.insertMode, caret(input,
                        opts.insertMode || pos.begin !== getMaskLength() ? pos.begin : pos.begin - 1));
            ...
            if (k) {
                ...
                if (valResult !== !1) {
                    ...
                    if (resetMaskSet(!0), void 0 !== valResult.caret) forwardPosition = valResult.caret;
                        ...
                        forwardPosition =
                            !opts.keepStatic &&
                            (void 0 !== vps[p + 1] && getTests(p + 1, vps[p].locator.slice(), p).length > 1 ||
        ...
        function pasteEvent(e) {
            ...
            return checkVal(input, !1, !1, isRTL ? pasteValue.split("").reverse() : pasteValue.toString().split("")),
                writeBuffer(input, getBuffer(), seekNext(getLastValidPosition()), e, !0),
                isComplete(getBuffer()) === !0 && $input.trigger("complete"),
                e.preventDefault();
        }
        ...
        function inputFallBackEvent(e) {
            ...
            if (getBuffer().join("") !== inputValue) {
                var caretPos = caret(input);
                if (inputValue =
                        inputValue.replace(new RegExp("(" + Inputmask.escapeRegex(getBufferTemplate().join("")) + ")*"),
                            ""),
                    iemobile) {
                    var inputChar = inputValue.replace(getBuffer().join(""), "");
                    if (1 === inputChar.length) {
                        var keypress = new $.Event("keypress");
                        return keypress.which = inputChar.charCodeAt(0), keypressEvent.call(input,
                                keypress,
                                !0,
                                !0,
                                !1,
                ...
                if (caretPos.begin > inputValue.length && (caret(input, inputValue.length), caretPos = caret(input)),
                    ...
                    for (var lvp = getLastValidPosition() + 1, bufferTemplate = getBuffer().slice(lvp).join("");
                        null === inputValue.match(Inputmask.escapeRegex(bufferTemplate) + "$");
                    ) bufferTemplate = bufferTemplate.slice(1);
                    inputValue = inputValue.replace(bufferTemplate, ""), inputValue = inputValue.split(""),
                        checkVal(input, !0, !1, inputValue), isComplete(getBuffer()) === !0 &&
        ...
        function setValueEvent(e) {
            ...
            checkVal(input,
                    !0,
                    !1,
                    ($.isFunction(opts.onBeforeMask) ? opts.onBeforeMask(value, opts) || value : value).split("")),
        ...
        function focusEvent(e) {
            ...
            opts.showMaskOnFocus && (!opts.showMaskOnHover || opts.showMaskOnHover && "" === nptValue)
                        ...
                        if (selectedCaret.begin === selectedCaret.end)
                            if (doRadixFocus(selectedCaret.begin))
                                ...
                                if (lastPosition > clickPosition)
                                    ...
                                    ("" !== placeholder && getBuffer()[lastPosition] !== placeholder ||
        ...
        function mask(elem) {
            if (el = elem, $el = $(el), opts.showTooltip && (el.title = opts.tooltip || getMaskSet().mask),
                ...
                (EventRuler.on(el, "submit", submitEvent),
                    ...
                    EventRuler.on(el, "blur", blurEvent), EventRuler.on(el, "focus", focusEvent), EventRuler.on(el,
                        "mouseleave",
                        mouseleaveEvent),
                    EventRuler.on(el, "click", clickEvent), EventRuler.on(el, "dblclick", dblclickEvent),
                    EventRuler.on(el, "paste", pasteEvent), EventRuler.on(el, "dragdrop", pasteEvent),
                    EventRuler.on(el, "drop", pasteEvent), EventRuler.on(el, "cut", cutEvent), EventRuler.on(el,
                        "complete",
                        opts.oncomplete),
        ...
        if (void 0 !== actionObj)
            ...
            case "unmaskedvalue":
                return el = actionObj.el, void 0 !== el && void 0 !== el.inputmask
                        ...
                        : (valueBuffer = actionObj.value,
                            opts.numericInput && (isRTL = !0), valueBuffer = ($.isFunction(opts.onBeforeMask)
            ...
            case "format":
                return opts.numericInput && (isRTL = !0), valueBuffer = ($.isFunction(opts.onBeforeMask)
            ...
            case "isValid":
                opts.numericInput && (isRTL = !0), actionObj.value
                    ? (valueBuffer = actionObj.value.split(""),
                        checkVal(void 0, !1, !0, isRTL ? valueBuffer.reverse() : valueBuffer))
            ...
            case "getmetadata":
                if ($.isArray(maskset.metadata)) {
                    for (var alternation, lvp = getLastValidPosition(void 0, !0), firstAlt = lvp;
                        firstAlt >= 0;
                        firstAlt--)
                        if (getMaskSet().validPositions[firstAlt] &&
                ...
                elems = elems.nodeName ? [elems] : elems, $.each(elems,
                    function(ndx, el) {
                        ...
                        (void 0 !== el.inputmask && el.inputmask.remove(), el.inputmask = new Inputmask(),
                            ...
                            el.inputmask.el = el, el.inputmask.maskset = maskset, el.inputmask.isRTL =
                                !1, $.data(el, "_inputmask_opts", scopedOpts),
                            maskScope({
                                action: "mask",
                                el: el
                            }));
                    ...
                    prevalidator: [
                        {
                            ...
                            validator: function(chrs, maskset, pos, strict, opts) {
                                ...
                                if (!strict && !isValid) {
                                    ...
                                    if (isValid)
                                        return maskset.buffer[pos - 1] = yearPrefix.charAt(0), maskset.buffer[pos++] =
                                                yearPrefix.charAt(1),
        ...
        numeric: {
            mask: function(opts) {
                ...
                opts.placeholder.length > 1 && (opts.placeholder = opts.placeholder.charAt(0)),
                    ...
                    opts.numericInput === !0 &&
                    (opts.radixFocus = !1, opts.digitsOptional = !1, isNaN(opts.digits) && (opts.digits = 2),
                ...
                return mask += "[+]", mask += opts.integerOptional === !0
                    ...
                    mask += "[-]", mask += autoEscape(opts.suffix), opts.greedy = !1, null !== opts.min &&
            ...
            postFormat: function(buffer, pos, opts) {
                ...
                buffer.length >= opts.suffix.length &&
                    buffer.join("").indexOf(opts.suffix) === buffer.length - opts.suffix.length &&
                ...
                if (bufVal.length > 0 && opts.autoGroup || -1 !== bufVal.indexOf(opts.groupSeparator)) {
                    ...
                    needsRefresh = 0 === bufVal.indexOf(opts.groupSeparator), bufVal =
                        bufVal.replace(new RegExp(escapedGroupSeparator, "g"), "");
                    var radixSplit = bufVal.split(opts.radixPoint);
                    if (bufVal =
                        "" === opts.radixPoint ? bufVal : radixSplit[0], bufVal !== opts.prefix + "?0" &&
            ...
            onBeforeWrite: function(e, buffer, caretPos, opts) {
                ...
                if (e && ("blur" === e.type || "checkval" === e.type || "keydown" === e.type)) {
                    ...
                    processValue = processValue.replace(opts.suffix, ""), processValue =
                            processValue.replace(new RegExp(Inputmask.escapeRegex(opts.groupSeparator), "g"), ""),
                        "," === opts.radixPoint && (processValue = processValue.replace(opts.radixPoint, "."));
                    var isNegative =
                        processValue.match(new RegExp("[-" + Inputmask.escapeRegex(opts.negationSymbol.front) + "]",
                            "g"));
                    if (isNegative = null !== isNegative && 1 === isNegative.length, processValue =
                        ...
                        if (null !== opts.min && isFinite(opts.min) && signedFloatValue < parseFloat(opts.min)
                                ...
                                (floatValue = Math.abs(opts.max),
                                    isNegative = opts.max < 0, maskedValue = void 0), processValue =
                        ...
                        if (floatValue.toString() !== processValue && floatValue.toString() + "." !== processValue ||
                            ...
                            return !isNegative ||
                                    ...
                                    (processValue.unshift(opts.negationSymbol.front),
                                        processValue.push(opts.negationSymbol.back)), processValue =
                                    (opts.prefix + processValue.join("")).split(""),
                                opts.numericInput && (processValue = processValue.reverse()), rslt =
                                    opts.postFormat(processValue, opts.numericInput ? caretPos : caretPos - 1, opts),
                ...
                if (!strict)
                    if (opts.numericInput === !0) {
                        ...
                        var radixPosition = $.inArray(opts.radixPoint, maskset.buffer),
                            matchRslt = maskset.buffer.slice(0, -1 !== radixPosition ? radixPosition : void 0).join("")
                        ...
                        if (matchRslt && (-1 === radixPosition || radixPosition >= pos)) {
                            ...
                            if (0 ===
                                matchRslt[0].indexOf("" !== opts.placeholder ? opts.placeholder.charAt(0) : "0") &&
                ...
                r: {
                    validator: function(chrs, maskset, pos, strict, opts) {
                                ...
                                if (matchToken.isGroup === !0) isvalid = validateRegexToken(matchToken, !0);
                                    ...
                                    if (isNaN(matchToken.quantifier.max)) {
                                        ...
                                        for (var i = 0, qm = matchToken.quantifier.max - 1;
                                            qm > i && !(isvalid = validateRegexToken(matchGroup, !0));
                                            i++);
                        ...
                        var bufferStr,
                            ...
                            isValid = !1,
                            openGroupCount = 0;
                        null === opts.regexTokens && analyseRegex(), cbuffer.splice(pos, 0, chrs), bufferStr =
                            cbuffer.join("");
